...
public class UniqueLastNames {
    ...
    public static void main(String[] args) {
        ...
        //print all the unique last names of the user given people in alphabetical order
        persons.stream()
                .map(x -> x.getLastName()) //map x to getLastName() method
                .distinct() //identifying unique values
                .sorted() //sort the numbers
                .forEach(x -> { 
                    System.out.println(x); //print out each values
                });
